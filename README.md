...
Budget App allows you to create cateories, and transactions based on these categories there by helping you to keep track of your transactions based on the categories. The application will enable you to add a photo or icon to a category, there by helping you to distinguish between them. The category consists of all the transaction details including the amount for each transaction and the total sum of transactions per category.
...
- Add a transaction based on a preffered category
- Display the details of all transactions in a particular category
...
- [ ] A desktop interface
- [ ] Add more functionality and authorization
...
I would also like to give a special shout out to [Gregoire Vella on Behance](https://www.behance.net/gregoirevella) for the amazing design template.
